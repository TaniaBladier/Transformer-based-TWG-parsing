...
SHORTUSAGE = '''
usage: discodop_n parser [options] <grammar/> [input [output]]
or:    discodop_n parser --simple [options] <rules> <lexicon> [input [output]]'''
...
def main():
	...
	if '--simple' in opts:
		...
		if not os.path.isdir(directory):
			raise ValueError('expected directory produced by "discodop_n runexp"')
